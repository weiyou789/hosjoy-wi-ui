...
class WiTextarea extends WiComponent {
    ...
    render () {
        ...
        const rootCls = classNames(
            ...
            `wi-textarea--${ENV}`,
            {
                'wi-textarea--error': _maxLength < value.length
            }, className
        )
        ...
        return <View className={rootCls} style={customStyle}>
            <Textarea
                className='wi-textarea__textarea'
                style={textareaStyle}
            ...
            />
            {count && (
                <View className='wi-textarea__counter'>
