...
export default class WiSearchBar extends WiComponent {
  ...
  render() {
    ...
    const rootCls = classNames('wi-search-bar', {
    ...
    return <View className={rootCls} style={customStyle}>
                <View className="wi-search-bar__input-cnt">
                    <View className="wi-search-bar__placeholder-wrap">
                        <Text className="wi-icon wi-icon-search"></Text>
                        <Text className="wi-search-bar__placeholder" style={placeholderStyle}>
                            {isFocus ? '' : placeholder}
                        </Text>
                    </View>
                    <Input className="wi-search-bar__input" type={inputType} confirmType="search" focus={isFocus} value={value} onInput={this.handleChange} onFocus={this.handleFocus} onBlur={this.handleBlur} onConfirm={this.handleConfirm} />
                    <View className="wi-search-bar__clear" style={clearIconStyle} onTouchStart={this.handleClear}>
                        <Text className="wi-icon wi-icon-close-circle"></Text>
                    </View>
                </View>
                <View className="wi-search-bar__action" style={actionStyle} onClick={this.handleActionClick}>
                    {actionName}
                </View>
            </View>;
  }
...
WiSearchBar.PropTypes = {
  ...
  actionStyle: PropTypes.oneOfType([PropTypes.array, PropTypes.string])
};