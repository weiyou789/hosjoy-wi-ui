...
export default class WiFloatLayout extends WiComponent {
  ...
  renderTitle(title) {
    return <View className="layout-header">
  ...
  renderBody() {
    ...
    return <View className="layout-body">
                <ScrollView scrollY scrollX={scrollX} onScroll={onScroll} className="layout-body__content">
                    {this.props.children}
                </ScrollView>
            </View>;
  }
  ...
  render() {
    ...
    const rootClass = classNames('wi-float-layout', {
