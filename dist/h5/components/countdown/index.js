...
export default class WiCountdown extends WiComponent {
  ...
  calculateTime() {
    ...
    if (_countTime > 0) {
      this._countTime -= 100;
      day = this.props.isShowDay ? Math.floor(_countTime / 1000 / 86400) : 0;
      hours = Math.floor(_countTime / 1000 / 3600) - day * 24;
    ...
    if (_count > 0) {
      day = this.props.isShowDay ? Math.floor(_count / 1000 / 86400) : 0;
      hours = Math.floor(_count / 1000 / 3600) - day * 24;
  ...
  renderTime(num, separator) {
    ...
    return <View className="wi-countdown__item">
...
WiCountdown.PropTypes = {
  ...
  classNameText: PropTypes.oneOfType([PropTypes.array, PropTypes.string]),
  format: PropTypes.object,
  isShowDay: PropTypes.bool,
  isShowMillSeconds: PropTypes.bool,
  endTime: PropTypes.oneOfType([PropTypes.object, PropTypes.string, PropTypes.number]),
  countTime: PropTypes.oneOfType([PropTypes.object, PropTypes.string, PropTypes.number]),
