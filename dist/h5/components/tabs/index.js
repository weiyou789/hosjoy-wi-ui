...
export default class WiTabs extends WiComponent {
  ...
  render() {
    ...
    return <View className={rootCls} style={this.mergeStyle(heightStyle, customStyle)}>
            {scroll ? <ScrollView id={this._tabId} className="wi-tabs__header" style={heightStyle} scrollX={scrollX} scrollY={scrollY} scrollWithAnimation scrollLeft={_scrollLeft} scrollTop={_scrollTop} scrollIntoView={_scrollIntoView}>
                {this.renderTabItems()}
            </ScrollView> : <View id={this._tabId} className="wi-tabs__header">
                {this.renderTabItems()}
            </View>}
            <View className="wi-tabs__body" onTouchStart={this.handleTouchStart.bind(this)} onTouchEnd={this.handleTouchEnd.bind(this)} onTouchMove={this.handleTouchMove.bind(this)} style={this.mergeStyle(bodyStyle, heightStyle)}>
