...
export default class WiProgress extends WiComponent {
  render() {
    ...
    const rootClass = classNames('wi-progress', {
    ...
    return <View className={rootClass}>
                <View className="wi-progress__outer">
                    <View className="wi-progress__outer-inner" style={bottomStyle}>
                        {this.props.children}
                        <View className="wi-progress__outer-inner-background" style={progressStyle}>
                        </View>
                    </View>
                </View>

                {!isHidePercent && <View className="wi-progress__content">
